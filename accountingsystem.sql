...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2018 at 08:40 AM
...
(23, 'Creditable Withholding Tax', '1005', 'Current Assets'),
(24, 'Withholding Tax Payable', '2004', 'Liabilities'),
(26, 'Labor', '6005', 'General & Administrative Expenses');
...
`customerid` int(12) NOT NULL,
  ...
  `customernumber` varchar(12) DEFAULT NULL
...
`supplierid` int(12) NOT NULL,
  ...
  `suppliernumber` varchar(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
ALTER TABLE `items`
MODIFY `itemnumber` int(12) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `purchaseorder`
MODIFY `purchaseorderid` int(99) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `uniqueitem`
MODIFY `uniqueItem` int(99) NOT NULL AUTO_INCREMENT;
--
