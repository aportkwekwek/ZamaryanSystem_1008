...
Public Class cashdisburse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ZamaryanSystem.cashdisburse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcashdisburse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cashdisburse = New cashdisburse()
        rpt.Site = Me.Site
        Return rpt
    End Function
