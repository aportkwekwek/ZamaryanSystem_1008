...
Public Class billingstatemt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ZamaryanSystem.billingstatemt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedbillingstatemt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As billingstatemt = New billingstatemt()
        rpt.Site = Me.Site
        Return rpt
    End Function
