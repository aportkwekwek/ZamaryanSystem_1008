...
Public Class recievingreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ZamaryanSystem.recievingreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrecievingreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As recievingreport = New recievingreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
