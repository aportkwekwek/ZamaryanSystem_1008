...
Public Class purcahseorder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ZamaryanSystem.purcahseorder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpurcahseorder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As purcahseorder = New purcahseorder()
        rpt.Site = Me.Site
        Return rpt
    End Function
